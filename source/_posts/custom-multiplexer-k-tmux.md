...
诚不欺我啊，我已经折腾了很久了，所以我想把自己的配置分享出来给大家。本文的目的是为了向大家介绍超级好用的终端多路器——tmux，以及 @wklken 和我配置好的 k-tmux 供大家使用，让你快速感受极致的终端体验！

<!--more-->

## 什么是 tmux

关于什么是 tmux 网上有太多太多的文章了，我就不赘述了。简单点说，tmux 是个终端多路器，允许你在一个终端中同时开启多个会话。
